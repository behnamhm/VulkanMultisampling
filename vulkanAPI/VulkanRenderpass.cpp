...
void VulkanRenderpass::createRenderPass(VkFormat &swapChainImageFormat)
{
	...
	colourAttachment.format = vulkanDevice.chooseSupportedFormat(
	...
	depthAttachment.format = vulkanDevice.chooseSupportedFormat(
	...
	VkResult result = vkCreateRenderPass(vulkanDevice.logicalDevice, &renderPassCreateInfo, nullptr, &renderPass);
